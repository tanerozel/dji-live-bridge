...
**Situs web:** https://tanerozel.github.io/dji-live-bridge/id/
...
3. Selesai. FFmpeg sudah ada di dalam aplikasi, tidak ada lagi yang perlu dipasang.
...
FFmpeg (LGPL) disertakan; teks lisensinya ada di `Contents/Resources/licenses` di dalam aplikasi.

## Tentang

**Taner Özel** — Pengembang

- Email: [tanerozel47@gmail.com](mailto:tanerozel47@gmail.com)
...
Proyek ini tidak berafiliasi dengan DJI, Instagram, atau TikTok.
