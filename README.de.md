...
3. FFmpeg ist nicht enthalten. Beim ersten Start merkt die App, dass es fehlt, und installiert es mit einem Klick für dich (über Homebrew) — mit Protokoll im Fenster. Von Hand: `brew install ffmpeg`.
